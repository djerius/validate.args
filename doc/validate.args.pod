...
object.  Objects may be themselves cloned, allowing for nested
...
This constructs a new validation object based upon the class defaults.  It
takes a table of named arguments:
...
the current option values set by the C<objs()> function.  If false
...
Set the specified validation options.  These hold for this object
only. An error will be thrown if the specified options are not
recognized.
