...
Returns true if C<arg> is a positive number.

=item zposnum( arg )

Returns true if C<arg> is a number greater or equal to zero.

=item posint( arg )

Returns true if C<arg> is a positive integer.

=item zposint( arg )

Returns true if C<arg> is an integer greater or equal to zero.
